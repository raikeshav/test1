...
$possible_plugin_locations = array(
	...
	'E:\xampp\htdocs\test1\wp-content\plugins\wp-optimize\cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/test1/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'E:\xampp\htdocs\test1\wp-content\plugins\wp-optimize\cache/extensions');
}
