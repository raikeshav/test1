...
function bosa_travel_tour_default_styles(){
	...
	# Responsive Events Highlight
	if( get_theme_mod( 'disable_mobile_events_highlight', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
				.section-event-area {
	    			display: none;
...
add_action( 'wp_head', 'bosa_travel_tour_default_styles', 99 );