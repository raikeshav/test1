...
if ( ! function_exists( 'bosa_travel_tour_enqueue_styles' ) ) :
	/**
	 * @since Bosa Travel Tour 1.0.0
	 */
	function bosa_travel_tour_enqueue_styles() {
        require_once get_theme_file_path ( 'inc/wptt-webfont-loader.php');

		wp_enqueue_style( 'bosa-travel-tour-style-parent', get_template_directory_uri() . '/style.css',
			array(
				'bootstrap',
				'slick',
				'slicknav',
        ...
        wp_enqueue_style(
            'bosa-travel-tour-google-fonts-two',
        ...
        wp_enqueue_script( 'bosa-travel-tour-custom-woo', get_stylesheet_directory_uri() . '/assets/js/custom-woo.js', array( 'jquery' ), '1.0', true );

	}

endif;
add_action( 'wp_enqueue_scripts', 'bosa_travel_tour_enqueue_styles', 10 );

/**
* Registers menu location. 
* @since Bosa Travel Tour 1.0.0
*/
function bosa_travel_tour_menu_register(){
    register_nav_menu(
        'menu-4', esc_html__( 'Category Menu', 'bosa-travel-tour' )
    );
}
add_action( 'after_setup_theme', 'bosa_travel_tour_menu_register' );

/**
* Add cart link
* @since Bosa Travel Tour 1.0.0
*/
if ( !function_exists( 'bosa_travel_tour_cart_link' ) ) {
    function bosa_travel_tour_cart_link() {
        ?>	
...
* @since Bosa Travel Tour 1.0.0
*/
if ( !function_exists( 'bosa_travel_tour_header_cart' ) ) {
    function bosa_travel_tour_header_cart() {
        ?>
            <div class="header-cart">
                <div class="header-cart-block">
                    <div class="header-cart-inner">
                        <?php bosa_travel_tour_cart_link(); ?>
...
* @since Bosa Travel Tour 1.0.0
*/
if ( !function_exists( 'bosa_travel_tour_header_add_to_cart_fragment' ) ) {
    function bosa_travel_tour_header_add_to_cart_fragment( $fragments ) {
        ob_start();
        bosa_travel_tour_cart_link();
        $fragments['a.cart-contents'] = ob_get_clean();
        return $fragments;
    }
    add_filter( 'woocommerce_add_to_cart_fragments', 'bosa_travel_tour_header_add_to_cart_fragment' );
}
...
* @since Bosa Travel Tour 1.0.0
*/
if ( !function_exists( 'bosa_travel_tour_head_wishlist' ) ) {
    function bosa_travel_tour_head_wishlist() {
            ...
            <div class="header-wishlist">
                <a href="<?php echo esc_url( $wishlist_url ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Wishlist', 'bosa-travel-tour' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa Travel Tour 1.0.0
*/
if (!function_exists( 'bosa_travel_tour_head_compare' ) ) {
    function bosa_travel_tour_head_compare() {
        if ( function_exists( 'yith_woocompare_constructor' ) ) {
            ...
            <div class="header-compare">
                <a class="compare added" rel="nofollow" href="<?php echo esc_url( $yith_woocompare->obj->view_table_url() ); ?>">
                    ...
                    <span class="info-tooltip">
                        <?php esc_html_e( 'Compare', 'bosa-travel-tour' ); ?>
                    </span>
                </a>
            </div>
            <?php
...
* @since Bosa Travel Tour 1.0.0
*/
if ( !function_exists( 'bosa_travel_tour_my_account' ) ) {
    function bosa_travel_tour_my_account() {
            ...
            <div class="header-my-account">
                <div class="header-login"> 
                    <a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>">
                        ...
                        <span class="info-tooltip">
                            <?php esc_html_e( 'My Account', 'bosa-travel-tour' ); ?>
                        </span>
                    </a>
                </div>
            </div>
...
* @return array.
*/
function bosa_travel_tour_get_pages(){
...
* @since Bosa Travel Tour 1.0.0
*/
if( !function_exists( 'bosa_travel_tour_blog_advertisement_banner' ) ){
    function bosa_travel_tour_blog_advertisement_banner(){
...
if ( ! function_exists( 'bosa_travel_tour_grid_thumbnail_date' ) ) :
    /**
     * Prints HTML with meta information for the tags and comments.
     */
    function bosa_travel_tour_grid_thumbnail_date() {
                    ...
                    comments_popup_link(
                        sprintf(
                            wp_kses(
                                ...
                                __( 'Comment<span class="screen-reader-text"> on %s</span>', 'bosa-travel-tour' ),
                                array(
                                    'span' => array(
                                        'class' => array(),
                                    ),
...
if( !function_exists( 'bosa_get_intermediate_image_sizes' ) ){
    ...
    */
    function bosa_get_intermediate_image_sizes(){
        ...
        $data   = array(
            'full'          => esc_html__( 'Full Size', 'bosa-travel-tour' ),
            'large'         => esc_html__( 'Large Size', 'bosa-travel-tour' ),
            'medium'        => esc_html__( 'Medium Size', 'bosa-travel-tour' ),
            'medium_large'  => esc_html__( 'Medium Large Size', 'bosa-travel-tour' ),
            'thumbnail'     => esc_html__( 'Thumbnail Size', 'bosa-travel-tour' ),
            '1536x1536'     => esc_html__( '1536x1536 Size', 'bosa-travel-tour' ),
            '2048x2048'     => esc_html__( '2048x2048 Size', 'bosa-travel-tour' ),
            'bosa-1920-550' => esc_html__( '1920x550 Size', 'bosa-travel-tour' ),
            'bosa-1370-550' => esc_html__( '1370x550 Size', 'bosa-travel-tour' ),
            'bosa-590-310'  => esc_html__( '590x310 Size', 'bosa-travel-tour' ),
            'bosa-420-380'  => esc_html__( '420x380 Size', 'bosa-travel-tour' ),
            'bosa-420-300'  => esc_html__( '420x300 Size', 'bosa-travel-tour' ),
            'bosa-420-200'  => esc_html__( '420x200 Size', 'bosa-travel-tour' ),
            'bosa-290-150'  => esc_html__( '290x150 Size', 'bosa-travel-tour' ),
            'bosa-80-60'    => esc_html__( '80x60 Size', 'bosa-travel-tour' ),
        );
...
if( !function_exists( 'bosa_travel_tour_archive_post_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'bosa_archive_post_layout_filter', 'bosa_travel_tour_archive_post_layout_filter' );
    function bosa_travel_tour_archive_post_layout_filter( $post_layout ){
...
if( !function_exists( 'bosa_travel_tour_header_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'bosa_header_layout_filter', 'bosa_travel_tour_header_layout_filter' );
    function bosa_travel_tour_header_layout_filter( $header_layout ){
        $added_header = array(
...
if( !function_exists( 'bosa_travel_tour_footer_layout_filter' ) ){
    /**
    ...
    * @return array
    */
    add_filter( 'bosa_footer_layout_filter', 'bosa_travel_tour_footer_layout_filter' );
    function bosa_travel_tour_footer_layout_filter( $footer_layout ){
        $added_footer = array(
...
* @return array
*/
function bosa_travel_tour_get_product_categories(){
...
if ( ! function_exists( 'bosa_travel_tour_modify_locale' ) ) :
    /**
     ...
     * @return array
     */
    function bosa_travel_tour_modify_locale( $locale ) {
    ...
    add_filter( 'bosa_localize_var', 'bosa_travel_tour_modify_locale' );
endif;

if( !function_exists( 'bosa_travel_tour_transparent_body_class' ) ){
    /**
    ...
    * @return array $class
    */
    function bosa_travel_tour_transparent_body_class( $class ){
    ...
    add_filter( 'body_class', 'bosa_travel_tour_transparent_body_class' );
}
