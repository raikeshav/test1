...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_travel_tour_blog_advertisement_banner(); ?>
			...
			<!--Blog Events Highlight-->
			<?php get_template_part( 'template-parts/events-highlight/events-highlight' ); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-travel-tour' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-travel-tour' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-travel-tour' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-travel-tour' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-travel-tour' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
