				...
				<div class="col-6 col-md-3">
					<?php if ( class_exists('WooCommerce' ) ) { ?>
					    <div class="header-right" >
					        <?php
					        if( !get_theme_mod( 'disable_woocommerce_compare', false ) ){bosa_travel_tour_head_compare();
					        }
					        if( !get_theme_mod( 'disable_woocommerce_wishlist', false ) ){bosa_travel_tour_head_wishlist();
					        }
					        if( !get_theme_mod( 'disable_woocommerce_account', false ) ){bosa_travel_tour_my_account();
					        }
					        if( !get_theme_mod( 'disable_woocommerce_cart', false ) ){bosa_travel_tour_header_cart();
					        }
					        ?>
					    </div>	
					<?php } ?>
			...
			<div class="row">
				<div class="col-lg-8 d-none d-lg-flex align-items-center">
					            ...
					            <ul class="nav navbar-nav navbar-left">
					                <li class="menu-item menu-item-has-children">
					                    <a href="#">
					                        ...
					                        <?php esc_html_e( 'Categories', 'bosa-travel-tour' ); ?>
					                    </a>
					                    <?php
					                    wp_nav_menu(array(
					                        'container'      => '',
					...
					<nav id="site-navigation" class="main-navigation d-none d-lg-flex">
						<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'bosa-travel-tour' ); ?></button>
