...
<div id="offcanvas-menu" class="offcanvas-menu-wrap">
	...
	<div class="offcanvas-menu-inner">
		<div class="offcanvas-menu-content">
			<?php if( get_theme_mod( 'header_layout', 'header_two' ) == 'header_fifteen' ){ ?>
			...
			<?php if( !get_theme_mod( 'disable_secondary_menu', false ) ){ ?>
				<?php if( get_theme_mod( 'header_layout', 'header_two' ) == 'header_three' || get_theme_mod( 'header_layout', 'header_two' ) == 'header_fifteen' ){ ?>
