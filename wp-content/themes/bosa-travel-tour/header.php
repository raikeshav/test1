...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'bosa-travel-tour' ); ?></a>
	...
	}elseif( get_theme_mod( 'header_layout', 'header_two' ) == 'header_fifteen' ) {
